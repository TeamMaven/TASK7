...
public class Controller extends HttpServlet {
	...
	public void init() throws ServletException {
        ...
        List<String> initVar = new ArrayList<String>();
        initVar.add("Sean");
        initVar.add("Divya");
        initVar.add("Alex");
        initVar.add("Karin");
        ...
        List<String> initUrl = new ArrayList<String>();
        initUrl.add("www.cmu.edu");
        initUrl.add("www.cmu.edu/blackboard/");
        initUrl.add("www.cmu.edu/career/tartantrak/index.html");
        initUrl.add("www.jeffeppinger.com/jle/08-600.html");
        ...
        for (String initMail : initVar) {
        	try {
				initUser = userDAO.read(initMail+"@andrew.cmu.edu");			
				if (initUser.length == 0) {
					UserBean newUser = new UserBean();
					newUser.setEmail(initMail+"@andrew.cmu.edu");
					newUser.setFirstName(initMail);
					newUser.setLastName(initMail);
					newUser.setPassword(initMail);
					userDAO.create(newUser);
					int addUrl=1;
					for (String initFav : initUrl) {
						fetchUser = userDAO.read(initMail+"@andrew.cmu.edu");
						FavoriteBean bean = new FavoriteBean();
			       		bean.setUserId(fetchUser[0].getUserId());
			       		bean.setUrl(initFav);
			       		bean.setComment(initMail+" favorite link "+addUrl);
